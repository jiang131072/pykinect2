# This file seemes to be generated by comtypes or so on.
# So we will not formulate it.

# TODO Regenerate with comtypes or so on (new verson).
...
<<<<<<<< HEAD:src/pykinect/interface.py
...
>>>>>>>> f3b65c3 (revert COM organize):src/pykinect/api.py
