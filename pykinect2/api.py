...
IBody._methods_ = [
    ...
    COMMETHOD(
        ["propget"], HRESULT, "Lean", (["retval", "out"], POINTER(_PointF), "amount")
    ),
    COMMETHOD(
        ["propget"],
        HRESULT,
...
IColorCameraSettings._methods_ = [
    ...
    COMMETHOD(
        ["propget"], HRESULT, "Gain", (["retval", "out"], POINTER(c_float), "Gain")
    ),
    COMMETHOD(
...
IDepthFrameArrivedEventArgs._methods_ = [
    COMMETHOD(
        ...
        (
            ["retval", "out"],
            POINTER(POINTER(IDepthFrameReference)),
            "depthFrameReference",
        ),
    ),
]
...
IAudioBeamFrameArrivedEventArgs._methods_ = [
    COMMETHOD(
        ...
        (
            ["retval", "out"],
            POINTER(POINTER(IAudioBeamFrameReference)),
...
ILongExposureInfraredFrameReader._methods_ = [
    ...
    COMMETHOD(
        ...
        (
            ["retval", "out"],
            POINTER(POINTER(ILongExposureInfraredFrame)),
    ...
    COMMETHOD(
        ...
        (
            ["retval", "out"],
            POINTER(POINTER(ILongExposureInfraredFrameSource)),
            "LongExposureInfraredFrameSource",
        ),
    ),
]
...
ILongExposureInfraredFrameArrivedEventArgs._methods_ = [
    COMMETHOD(
        ...
        (
            ["retval", "out"],
            POINTER(POINTER(ILongExposureInfraredFrameReference)),
...
IBodyFrameSource._methods_ = [
    ...
    COMMETHOD([], HRESULT, "OverrideHandTracking", ([], c_ulonglong, "TrackingId")),
    COMMETHOD(
        [],
        HRESULT,
        "OverrideAndReplaceHandTracking",
...
IAudioBeamFrameList._methods_ = [
    COMMETHOD(
        ["propget"], HRESULT, "BeamCount", (["retval", "out"], POINTER(c_uint), "count")
    ),
    COMMETHOD(
        [],
        HRESULT,
...
IColorFrameArrivedEventArgs._methods_ = [
    COMMETHOD(
        ...
        (
            ["retval", "out"],
            POINTER(POINTER(IColorFrameReference)),
            "colorFrameReference",
        ),
    ),
]
...
IAudioSource._methods_ = [
    ...
    COMMETHOD(
        ...
        (
            ["retval", "out"],
            POINTER(_KinectAudioCalibrationState),
            "AudioCalibrationState",
        ),
    ),
]
...
IBodyIndexFrameReader._methods_ = [
    ...
    COMMETHOD(
        ...
        (
            ["retval", "out"],
            POINTER(POINTER(IBodyIndexFrameSource)),
            "BodyIndexFrameSource",
        ),
    ),
]
...
IBodyFrameArrivedEventArgs._methods_ = [
    COMMETHOD(
        ...
        (
            ["retval", "out"],
            POINTER(POINTER(IBodyFrameReference)),
            "bodyFrameReference",
        ),
    ),
]
...
IBodyIndexFrameArrivedEventArgs._methods_ = [
    COMMETHOD(
        ...
        (
            ["retval", "out"],
            POINTER(POINTER(IBodyIndexFrameReference)),
...
IColorFrame._methods_ = [
    ...
    COMMETHOD(
        ...
        (
            ["retval", "out"],
            POINTER(POINTER(IColorCameraSettings)),
            "ColorCameraSettings",
        ),
    ),
    COMMETHOD(
...
IFrameDescription._methods_ = [
    COMMETHOD(
        ["propget"], HRESULT, "Width", (["retval", "out"], POINTER(c_int), "Width")
    ),
    COMMETHOD(
        ["propget"], HRESULT, "Height", (["retval", "out"], POINTER(c_int), "Height")
    ),
    COMMETHOD(
        ["propget"],
        HRESULT,
...
ILongExposureInfraredFrameSource._methods_ = [
    ...
    COMMETHOD(
        ...
        (
            ["retval", "out"],
            POINTER(POINTER(ILongExposureInfraredFrameReader)),
            "reader",
        ),
    ),
    COMMETHOD(
...
IMultiSourceFrame._methods_ = [
    ...
    COMMETHOD(
        ...
        (
            ["retval", "out"],
            POINTER(POINTER(IInfraredFrameReference)),
            "infraredFrameReference",
        ),
    ),
    COMMETHOD(
...
IInfraredFrameReader._methods_ = [
    ...
    COMMETHOD(
        ...
        (
            ["retval", "out"],
            POINTER(POINTER(IInfraredFrameSource)),
            "InfraredFrameSource",
        ),
    ),
]
...
IKinectSensor._methods_ = [
    ...
    COMMETHOD(
        ["propget"], HRESULT, "IsOpen", (["retval", "out"], POINTER(c_bool), "IsOpen")
    ),
    COMMETHOD(
        ["propget"],
        HRESULT,
    ...
    COMMETHOD(
        ...
        (
            ["retval", "out"],
            POINTER(POINTER(IMultiSourceFrameReader)),
...
__all__ = [
    ...
    "FrameSourceTypes_Audio",
    "JointType_ThumbRight",
    "_FrameEdges",
    "IAudioBeamFrameList",
    "IBodyIndexFrame",
    "FrameCapturedStatus_Dropped",
    "tagSTATSTG",
    "IBodyFrameReference",
    "IFrameDescription",
    "FrameEdge_Right",
    ...
    "AudioBeamMode_Manual",
    "_JointOrientation",
    "Activity_EyeRightClosed",
    "IBodyIndexFrameReference",
    "IStream",
    "KinectCapabilities_Face",
    "Expression_Count",
    "JointType_HandLeft",
    ...
    "JointType_KneeLeft",
    "KinectCapabilities_Vision",
    "IDepthFrame",
    "IColorFrame",
    "_HandState",
    "IBodyIndexFrameReader",
    "_CameraIntrinsics",
    "_KinectAudioCalibrationState",
    "IAudioBodyCorrelation",
    "IColorFrameSource",
    "DetectionResult_Yes",
    "IDepthFrameReader",
    "Appearance_WearingGlasses",
    "KinectCapabilities_Gamechat",
    "AudioBeamMode_Automatic",
    ...
    "ISequentialStream",
    "IAudioBeamFrameArrivedEventArgs",
    "IBody",
    "IMultiSourceFrame",
    "ICoordinateMapper",
    ...
    "FrameSourceTypes_None",
    "DetectionResult_Unknown",
    "_Appearance",
    ...
    "_ColorImageFormat",
    "KinectCapabilities_Expressions",
